...
export async function initDb() {
  ...
  await db.run(`ALTER TABLE request_logs ADD COLUMN IF NOT EXISTS requested_model TEXT`);
  await db.run(`ALTER TABLE request_logs ADD COLUMN IF NOT EXISTS resolved_model TEXT`);
  await db.run(`ALTER TABLE request_logs ADD COLUMN IF NOT EXISTS routing_reason TEXT`);
